...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 ?>
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="course_desc">Event Description</label>
    ...
    <div class="form-group">
      <label for="course_author">Scheduler Name</label>
    ...
    <div class="form-group">
      <label for="course_duration">Event Duration</label>
    ...
    <div class="form-group">
      <label for="course_original_price">Event Original Price</label>
    ...
    <div class="form-group">
      <label for="course_price">Event Selling Price</label>
    ...
    <div class="form-group">
      <label for="course_img">Event Image</label>
